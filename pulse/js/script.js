$(document).ready(function () {
    ...
    /*     $('#consultation-form').validate();
        $('#consultation form').validate({
            ...
            messages: {
                name: {
                    required: "Пожулуйста, введите свое имя",
                    minlength: jQuery.validator.format("Введите {0} символа!")
                },
                phone: "Пожулуйста, введите свой номер телефона",
                email: {
                    required: "Пожулуйста, введите свою почту",
                    email: "Ваш адрес email должен быть в формате name@domain.com"
                }
            }
        });
        $('#order form').validate(); */
    ...
    function validateForms(form) {
        $(form).validate({
            ...
            messages: {
                ...
                phone: "Пожулуйста, введите свой номер<br>телефона",
                email: {
                    required: "Пожулуйста, введите свою почту",
                    email: "Ваш адрес email должен быть в формате name@domain.com"
                }
